...
export default function DrawerContent({ t, record, onClose, medicines, show }) {
  ...
  const activityLabels = t.activityLabels ?? [
    "None",
    "< 1 hour",
    "1–2 hours",
    "2–3 hours",
    ...
    <div className="px-5 pb-6 pt-2">
      ...
      <div className="space-y-2 mb-4">
        ...
        {visibleSymptoms.map(({ key, labelKey, fallback }) => {
          ...
          const threshold = key === "period" ? 2 : 2;
          if (!val || val < threshold) return null;
          return (
      ...
      {hasAbsence && (
        <div
          ...
          style={{
            background: "rgba(201,112,96,0.06)",
            ...
            {hasActivity && (
              <div className="flex items-center justify-between">
                ...
                <span
                  ...
                  style={{ color: "#3a8a3a" }}
                >
                  {activityLabels[record.physicalActivity] ??
      ...
      {showNote && hasNote && (
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#5a3a34" }}>
            {record.note}
          </p>
        </div>
      )}
