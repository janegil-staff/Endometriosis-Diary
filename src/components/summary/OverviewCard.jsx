...
export function OverviewCard({ t, records }) {
  ...
  const stats = [
    ...
    { label: t.exacerbation    ?? "Flare-ups",      value: flareUps,        color: flareUps > 0 ? "#f5a623" : "#4CC189"           },
    ...
    { label: (t.absentWork   ?? "Absent work")   + ` (${t.partial ?? "part"})`,  value: absentWorkPartial,   color: absentWorkPartial   > 0 ? "#FFC659" : "#4CC189" },
    { label: (t.absentWork   ?? "Absent work")   + ` (${t.full    ?? "full"})`,   value: absentWorkFull,      color: absentWorkFull      > 0 ? "#FF7473" : "#4CC189" },
    { label: (t.absentSocial ?? "Absent social") + ` (${t.partial ?? "part"})`,  value: absentSocialPartial, color: absentSocialPartial > 0 ? "#FFC659" : "#4CC189" },
    { label: (t.absentSocial ?? "Absent social") + ` (${t.full    ?? "full"})`,   value: absentSocialFull,    color: absentSocialFull    > 0 ? "#FF7473" : "#4CC189" },
  ];
