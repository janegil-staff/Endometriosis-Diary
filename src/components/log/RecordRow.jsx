...
const SYMPTOM_FIELDS = [
  ...
  {
    key: "urinationPain",
    labelKey: "symptomUrination",
    fallback: "Urination pain",
  },
    ...
    >
      ...
      {expanded && (
        <div
          ...
          style={{
            borderTop: "1px solid rgba(201,112,96,0.1)",
            paddingTop: 14,
          }}
        >
          {/* Symptom bars */}
          ...
          {(hasActivity || hasSleep) && (
            <div className="flex gap-2">
              {hasActivity && (
                ...
                >
                  <p className="text-xs" style={{ color: "#3a8a3a" }}>
                    {t.physicalActivity ?? "Activity"}
                  </p>
                  <p className="text-sm font-bold" style={{ color: "#3a8a3a" }}>
                    {actLabel}
                  </p>
                </div>
              )}
              {hasSleep && (
                ...
                >
                  <p className="text-xs" style={{ color: "#7b68ee" }}>
                    {t.symptomSleep ?? "Sleep"}
                  </p>
                  <p className="text-sm font-bold" style={{ color: "#7b68ee" }}>
                    {sleepLabel}
                  </p>
                </div>
              )}
          ...
          {noteText && (
            ...
            >
              ...
              <p className="text-sm" style={{ color: "#5a3a34" }}>
                {noteText}
              </p>
            </div>
          )}
